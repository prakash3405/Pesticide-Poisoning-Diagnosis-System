...
MySQL - 5.5.29 : Database - pesticide_poisoning_diagnosis
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pesticide_poisoning_diagnosis` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `pesticide_poisoning_diagnosis`;
...
insert  into `remote_user_detection_ratio`(`id`,`names`,`ratio`) values (6,'Pesticide Poisoning Detected','100.0');

/*Table structure for table `remote_user_pesticide_poisoning_diagnosis` */

DROP TABLE IF EXISTS `remote_user_pesticide_poisoning_diagnosis`;

CREATE TABLE `remote_user_pesticide_poisoning_diagnosis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Age` varchar(3000) NOT NULL,
  `Years_of_Exposure` varchar(3000) NOT NULL,
  `Number_of_Symptoms` varchar(3000) NOT NULL,
  `Protective_Gear_Usage` varchar(3000) NOT NULL,
  `Work_Hours_per_Day` varchar(3000) NOT NULL,
  `Proximity_to_Pesticide_Storage` varchar(3000) NOT NULL,
  `Gender` varchar(3000) NOT NULL,
  `Pesticide_Type` varchar(3000) NOT NULL,
  `Location` varchar(3000) NOT NULL,
  `Symptoms` varchar(3000) NOT NULL,
  `Pesticide_Contact` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

/*Data for the table `remote_user_pesticide_poisoning_diagnosis` */

/*Table structure for table `remote_user_pesticide_poisoning_diagnosis_accuracy` */

DROP TABLE IF EXISTS `remote_user_pesticide_poisoning_diagnosis_accuracy`;

CREATE TABLE `remote_user_pesticide_poisoning_diagnosis_accuracy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `ratio` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
/*Data for the table `remote_user_pesticide_poisoning_diagnosis_accuracy` */
